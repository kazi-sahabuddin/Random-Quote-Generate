...
function main(){
    ...
    const quoteProf = document.getElementById("quote-prof");

    btnNewQuote.addEventListener('click', function(){
        const index = Math.floor(Math.random()*meaningfulQuotes.length);
        quote.innerHTML = meaningfulQuotes[index].quote;
        quoteAuthor.innerHTML = meaningfulQuotes[index].author;
        quoteProf.innerHTML = meaningfulQuotes[index].profession;
    });
